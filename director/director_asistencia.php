                    ...
                    <div class="panel-body">
                        ...
                        <div class="panel panel-default" style="margin-bottom:5px">
                            <div class="panel-heading" style="background-color:white">
                                <div class="row">
                                    <a href="director_asistencia8A.php" style="color:black">
                                        <div class="col-sm-6">
                        ...
                        <div class="panel panel-default" style="margin-bottom:5px">
                            <div class="panel-heading" style="background-color:white">
                                <div class="row">
                                    <a href="director_asistencia8B.php" style="color:black">
                                        <div class="col-sm-6">
                                            <h4 class="course-title">
                                                <img src="../img/CURSO.png" width="15px">
                                                <strong class="curso-lista">CURSO:</strong>
                        ...
                        <div class="panel panel-default" style="margin-bottom:5px">
                            <div class="panel-heading" style="background-color:white">
                                <div class="row">
                                    <a href="director_asistencia9A.php" style="color:black">
                                        <div class="col-sm-6">
                                            <h4 class="course-title">
                                                <img src="../img/CURSO.png" width="15px">
                                                <strong class="curso-lista">CURSO:</strong>
                        ...
                        <div class="panel panel-default" style="margin-bottom:5px">
                            <div class="panel-heading" style="background-color:white">
                                <div class="row">
                                    <a href="director_asistencia9B.php" style="color:black">
                                        <div class="col-sm-6">
                                            <h4 class="course-title">
                                                <img src="../img/CURSO.png" width="15px">
                                                <strong class="curso-lista">CURSO:</strong>
                        ...
                        <div class="panel panel-default" style="margin-bottom:5px">
                            <div class="panel-heading" style="background-color:white">
                                <div class="row">
                                    <a href="director_asistencia10A.php" style="color:black">
                                        <div class="col-sm-6">
                                            <h4 class="course-title">
                                                <img src="../img/CURSO.png" width="15px">
                                                <strong class="curso-lista">CURSO:</strong>
                        ...
                        <div class="panel panel-default" style="margin-bottom:5px">
                            <div class="panel-heading" style="background-color:white">
                                <div class="row">
                                    <a href="director_asistencia10B.php" style="color:black">
                                        <div class="col-sm-6">
                                            <h4 class="course-title">
                                                <img src="../img/CURSO.png" width="15px">
                                                <strong class="curso-lista">CURSO:</strong>
                        ...
                        <div class="panel panel-default" style="margin-bottom:5px">
                            <div class="panel-heading" style="background-color:white">
                                <div class="row">
                                    <a href="director_asistencia1CIENTIFICO.php" style="color:black">
                                        <div class="col-sm-6">
                                            <h4 class="course-title">
                                                <img src="../img/CURSO.png" width="15px">
                                                <strong class="curso-lista">CURSO:</strong>
                        ...
                        <div class="panel panel-default" style="margin-bottom:5px">
                            <div class="panel-heading" style="background-color:white">
                                <div class="row">
                                    <a href="director_asistencia1CONTABILIDAD.php" style="color:black">
                                        <div class="col-sm-6">
                                            <h4 class="course-title">
                                                <img src="../img/CURSO.png" width="15px">
                                                <strong class="curso-lista">CURSO:</strong>
                        ...
                        <div class="panel panel-default" style="margin-bottom:5px">
                            <div class="panel-heading" style="background-color:white">
                                <div class="row">
                                    <a href="director_asistencia1INFORMATICA.php" style="color:black">
                                        <div class="col-sm-6">
                                            <h4 class="course-title">
                                                <img src="../img/CURSO.png" width="15px">
                                                <strong class="curso-lista">CURSO:</strong>
                        ...
                        <div class="panel panel-default" style="margin-bottom:5px">
                            <div class="panel-heading" style="background-color:white">
                                <div class="row">
                                    <a href="director_asistencia2CIENTIFICO.php" style="color:black">
                                        <div class="col-sm-6">
                                            <h4 class="course-title">
                                                <img src="../img/CURSO.png" width="15px">
                                                <strong class="curso-lista">CURSO:</strong>
                        ...
                        <div class="panel panel-default" style="margin-bottom:5px">
                            <div class="panel-heading" style="background-color:white">
                                <div class="row">
                                    <a href="director_asistencia3CIENTIFICO.php" style="color:black">
                                        <div class="col-sm-6">
                                            <h4 class="course-title">
                                                <img src="../img/CURSO.png" width="15px">
                                                <strong class="curso-lista">CURSO:</strong>
                        ...
                        <div class="panel panel-default" style="margin-bottom:5px">
                            <div class="panel-heading" style="background-color:white">
                                <div class="row">
                                    <a href="director_asistencia3CONTABILIDAD.php" style="color:black">
                                        <div class="col-sm-6">
                                            <h4 class="course-title">
                                                <img src="../img/CURSO.png" width="15px">
                                                <strong class="curso-lista">CURSO:</strong>
                        ...
                        <div class="panel panel-default" style="margin-bottom:5px">
                            <div class="panel-heading" style="background-color:white">
                                <div class="row">
                                    <a href="director_asistencia3INFORMATICA.php" style="color:black">
                                        <div class="col-sm-6">
                                            <h4 class="course-title">
                                                <img src="../img/CURSO.png" width="15px">
                                                <strong class="curso-lista">CURSO:</strong>
