                            ...
                            <table class="table table-bordered table-hover">
                                ...
                                <tbody style="background-color:white">  
                                    ...
                                    <tr>
                                        <td>
                                            <p class="student-list">
                                                <span class="list-asist">1</span> ALEJANDRO MANUEL AYALA FARIAS
                                            </p>
                                        </td> 
                                        <form>
                                            <td class="text-center">
                                    ...
                                    <tr>
                                        <td>
                                            <p class="student-list">
                                                <span class="list-asist">1</span> JOSUE SANTIAGO BAIDAL SUAREZ 
                                            </p>
                                        </td> 
                                        <form>
                                            <td class="text-center">
                                                <div class="checkboxNotas"> 
                                                    <input class="text-center" type="checkbox" value="d1" id="checkboxNotas">
                                                    <label for="checkboxNotas"></label>
                                                </div>
                                            </td>
                                            <td class="text-center">
                                                <div class="checkboxNotas"> 
                                                    <input class="text-center" type="checkbox" value="d2" id="checkboxNotas">
                                                    <label for="checkboxNotas"></label>
                                                </div>
                                            </td>
                                            <td class="text-center">
                                                <div class="checkboxNotas"> 
                                                    <input class="text-center" type="checkbox" value="d3" id="checkboxNotas">
                                                    <label for="checkboxNotas"></label>
                                                </div>
                                            </td>
                                        </form>
                                    ...
                                    <tr>
                                        <td>
                                            <p class="student-list">
                                                <span class="list-asist">1</span> DAVID SEBASTIAN BECERRA SANCHEZ
                                            </p>
                                        </td> 
                                        <form>
                                            <td class="text-center">
                                    ...
                                    <tr>
                                        <td>
                                            <p class="student-list">
                                                <span class="list-asist">1</span> MARIO ISRAEL CABALLERO CHILA
                                            </p>
                                        </td> 
                                        <form>
                                            <td class="text-center">
                                    ...
                                    <tr>
                                        <td>
                                            <p class="student-list">
                                                <span class="list-asist">1</span> DAVID ESTEBAN CALDERON CARRERA
                                            </p>
                                        </td> 
                                        <form>
                                            <td class="text-center">
                                    ...
                                    <tr>
                                       <td>
                                            <p class="student-list">
                                                <span class="list-asist">1</span> JEREMIE ELIAS DAQUILEMA NAVARRO
                                            </p>
                                        </td> 
                                        <form>
                                            <td class="text-center">
                                    ...
                                    <tr>
                                       <td>
                                            <p class="student-list">
                                                <span class="list-asist">1</span> JAIME IVAN DUEÑAS CHOEZ
                                            </p>
                                        </td> 
                                        <form>
                                            <td class="text-center">
                                    ...
                                    <tr>
                                        <td>
                                            <p class="student-list">
                                                <span class="list-asist">1</span> CARLOS JAVIER GARCIA RAMONES
                                            </p>
                                        </td> 
                                        <form>
                                            <td class="text-center">
                                    ...
                                    <tr>
                                        <td>
                                            <p class="student-list">
                                                <span class="list-asist">1</span> ANDREA MELISA HABLICH PAREDES 
                                            </p>
                                        </td> 
                                        <form>
                                            <td class="text-center">
                                    ...
                                    <tr>
                                        <td>
                                            <p class="student-list">
                                                <span class="list-asist">1</span> BRUNO MAURICIO LOGROÑO ORTIZ
                                            </p>
                                        </td> 
                                        <form>
                                            <td class="text-center">
                                    ...
                                    <tr>
                                        <td>
                                            <p class="student-list">
                                                <span class="list-asist">1</span> LISSETTE PRISCILA MENDOZA AVILEZ
                                            </p>
                                        </td> 
                                        <form>
                                            <td class="text-center">
                                    ...
                                    <tr>
                                        <td>
                                            <p class="student-list">
                                                <span class="list-asist">1</span> BRYAN NORBERTO MOREIRA PARRALES
                                            </p>
                                        </td> 
                                        <form>
                                            <td class="text-center">
                                    ...
                                    <tr>
                                        <td>
                                            <p class="student-list">
                                                <span class="list-asist">1</span> MAYERLI ADALIZ ORELLANA ROJAS 
                                            </p>
                                        </td> 
                                        <form>
                                            <td class="text-center">
                                    ...
                                    <tr>
                                        <td>
                                            <p class="student-list">
                                                <span class="list-asist">1</span> GERSSON ALEXANDER PEREZ NUÑEZ
                                            </p>
                                        </td> 
                                        <form>
                                            <td class="text-center">
                                    ...
                                    <tr>
                                        <td>
                                            <p class="student-list">
                                                <span class="list-asist">1</span> GRACE STEFANIE SOLORZANO MENDIETA
                                            </p>
                                        </td> 
                                        <form>
                                            <td class="text-center">
                                    ...
                                    <tr>
                                        <td>
                                            <p class="student-list">
                                               <span class="list-asist">1</span>  DIANA CAROLINA URRUTIA MOLINA
                                            </p>
                                        </td> 
                                        <form>
                                            <td class="text-center">
                                    ...
                                    <tr>
                                        <td>
                                            <p class="student-list">
                                                <span class="list-asist">1</span> YELENA MARIA VASQUEZ RODRIGUEZ
                                            </p>
                                        </td> 
                                        <form>
                                            <td class="text-center">
                                    ...
                                    <tr>
                                        <td>
                                            <p class="student-list">
                                                <span class="list-asist">1</span> WILSON GARLIS VELASCO CALERO
                                            </p>
                                        </td> 
                                        <form>
                                            <td class="text-center">
                                    ...
                                    <tr>
                                        <td>
                                            <p class="student-list">
                                                <span class="list-asist">1</span> ANTHONY ISMAELVELES GARCIA
                                            </p>
                                        </td> 
                                        <form>
                                            <td class="text-center">
                                    ...
                                    <tr>
                                        <td>
                                            <p class="student-list">
                                                <span class="list-asist">1</span> DAYANA GISSELLE ZAMORA GUSMAN
                                            </p>
                                        </td> 
                                        <form>
                                            <td class="text-center">
