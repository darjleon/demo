...
<div id="wrapper">
    ...
    <div id="page-wrapper" class="gray-bg dashbard-1">
        ...
        <div class="row wrapper white-bg ">                        
            <div class="col-lg-12">
                <h2 style="margin: 1em 0">Informacion Institucional</h2>
            </div>
        </div>
            ...
            <div class="row" style="padding-top:50px"> 
                        ...
                        <div class="row">
                            <div class="col-xs-4">
                                <a href="director_institucion.php">
                                    <img src="../img/institucion.png" width="125px">
                                </a><br>                                        
                            </div>                                                                
                        </div>
                        <h2>Institución</h2>
                ...
                <div class="col-lg-3">
                    <div class="widget style1">
                        <div class="row">
                            <div class="col-xs-4">
                                <a href="director_profesores.php">
                                    <img src="../img/docentes.png" width="125px">
                                </a><br> 
                            </div>                                                                
                        </div>
                        <h2>Profesores</h2>
                ...
                <div class="col-lg-3">
                    <div class="widget style1">
                        <div class="row">
                            <div class="col-xs-4">
                                <a href="director_alumnos.php">
                                    <img src="../img/estudiantes.png" width="125px">
                                </a><br>                                         
                            </div>                                                                
                        </div>
                        <h2>Alumnos</h2>
                ...
                <div class="col-lg-3">
                    <div class="widget style1">
                        <div class="row">
                            <div class="col-xs-4">
                                <a href="director_personal.php">
                                    <img src="../img/personal.png" width="125px">
                                </a><br>                                         
                            </div>                                                                
                        </div>
                        <h2>Personal</h2>
