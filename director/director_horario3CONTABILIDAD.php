    ...
    <div id="page-wrapper" class="gray-bg dashbard-1">
        ...
        <div class="row wrapper white-bg "> 
            <div class="col-xs-12 seleccion-curso">
                <h2 style="margin:1em 0">Horario 3RO BACHILLERATO CONTABILIDAD</h2>
                <div class="formatos">
                    <div class="back">
                        <a href="director_horarios.php">
                                ...
                                <table class="table ss1">
                                    ...
                                    <tbody id="horario">
                                        ...
                                        <tr>
                                            ...
                                            <td class="subject" style="vertical-align: middle">INVESTIGACION</td> 
                                            <td class="subject" style="vertical-align: middle">MATEMATICAS</td> 
                                            <td class="subject" style="vertical-align: middle">GESTION ADMINISTRACION DE LOS RRHH</td>
                                        ...
                                        <tr>
                                            ...
                                            <td class="subject" style="vertical-align: middle">FYOL</td> 
                                            <td class="subject" style="vertical-align: middle">PRODUCTOS Y SERVICIOS</td> 
                                        ...
                                        <tr>
                                            ...
                                            <td class="subject" style="vertical-align: middle">APLICACIONES INFORMATICAS</td> 
...
<script type="text/javascript">
    var xhttp = new XMLHttpRequest();
      ...
      xhttp.open("GET", "xml/schedule3CONTABILIDAD.xml", true);
      xhttp.send();
