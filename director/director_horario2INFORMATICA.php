    ...
    <div id="page-wrapper" class="gray-bg dashbard-1">
        ...
        <div class="row wrapper white-bg "> 
            <div class="col-xs-12 seleccion-curso">
                <h2 style="margin:1em 0">Horario 2DO BACHILLERATO INFORMATICA</h2>
                <div class="formatos">
                    <div class="back">
                        <a href="director_horarios.php">
                                ...
                                <table class="table ss1">
                                    ...
                                    <tbody id="horario">
                                        <!--<tr>
                                            ...
                                            <td class="subject" style="vertical-align: middle">PROGRAMACION EN LENGUAJE ESTRUCTURADO</td> 
                                            <td class="subject" style="vertical-align: middle">SISTEMAS INFORMATICOS MULTIDISPOSITIVOS Y EN RED</td>
                                        ...
                                        <tr>
                                            ...
                                            <td class="subject" style="vertical-align: middle">EDUCACION ARTTISTICA</td> 
                                            <td class="subject" style="vertical-align: middle">FISICA QUIMICA</td> 
                                            <td class="subject" style="vertical-align: middle">PROGRAMACION EN LENGUAJE ESTRUCTURADO</td>
                                            <td class="subject" style="vertical-align: middle">SISTEMAS INFORMATICOS MULTIDISPOSITIVOS Y EN RED</td> 
                                        </tr>
...
<script type="text/javascript">
    var xhttp = new XMLHttpRequest();
      ...
      xhttp.open("GET", "xml/schedule2INFORMATICA.xml", true);
      xhttp.send();
