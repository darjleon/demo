...
<div id="wrapper">
    ...
    <div id="page-wrapper" class="gray-bg dashbard-1">
        ...
        <div class="row wrapper white-bg "> 
            <div class="col-xs-12 seleccion-curso lista-general">
                <h3 style="margin:1em 0">
                    <p>
                    Lista de Alumnos:  
                    <span class="not">1RO BACHILLERATO CONTABILIDAD </span></p>
                    <p>              
                    Dirigente: 
                    <span class="not">SONIA RODRIGUEZ NOBOA</span>                    
                    </p>
                </h3>
                <div class="formatos">
                    <div class="back">
        ...
        <div class="wrapper wrapper-content">
            <?php include ('include/1CONTABILIDADlista.php'); ?>
        </div> 
    </div>
</div>
