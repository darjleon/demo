    ...
    <!--<div class="col-xs-12"> 
        ...
        <div class="docente">
            <div class="alumno">
                ...
                <p class="list">1</p>
                <p ><img class="icono-alumno student-list-icon" src="../img/icono_persona.png"> APAZA BASILIO LEONARDO MIGUEL <a href="">Perfil</a></p>
            </div>
        ...
        <div class="docente">
            <div class="alumno">
                <div class="alumno-name">Alumno</div>
                <p class="list">2</p>
                <p ><img class="icono-alumno student-list-icon" src="../img/icono_persona.png"> BALDERA OBREGON RONALDO TYSON <a href="">Perfil</a></p>
            </div>
            <div class="separador"></div>
            <div class="representante">
                <div class="representante-name">Representante</div>
        ...
        <div class="docente">
            <div class="alumno">
                <div class="alumno-name">Alumno</div>
                <p class="list">3</p>
                <p ><img class="icono-alumno student-list-icon" src="../img/icono_persona.png"> CALDERON GUEVARA JOEL ALEXANDER <a href="">Perfil</a></p>
            </div>
            <div class="separador"></div>
            <div class="representante">
                <div class="representante-name">Representante</div>
        ...
        <div class="docente">
            <div class="alumno">
                <div class="alumno-name">Alumno</div>
                <p class="list">4</p>
                <p ><img class="icono-alumno student-list-icon" src="../img/icono_persona.png"> ESTELA SAMANEZ ISAAC MANUEL <a href="">Perfil</a></p>
            </div>
            <div class="separador"></div>
            <div class="representante">
                <div class="representante-name">Representante</div>
        ...
        <div class="docente">
            <div class="alumno">
                <div class="alumno-name">Alumno</div>
                <p class="list">5</p>
                <p ><img class="icono-alumno student-list-icon" src="../img/icono_persona.png"> FLORES MESA MILAGROS JANETH <a href="">Perfil</a></p>
            </div>
            <div class="separador"></div>
            <div class="representante">
                <div class="representante-name">Representante</div>
        ...
        <div class="docente">
            <div class="alumno">
                <div class="alumno-name">Alumno</div>
                <p class="list">6</p>
                <p ><img class="icono-alumno student-list-icon" src="../img/icono_persona.png"> GUEVARA MERA JORGE LUIS <a href="">Perfil</a></p>
            </div>
            <div class="separador"></div>
            <div class="representante">
                <div class="representante-name">Representante</div>
        ...
        <div class="docente">
            <div class="alumno">
                <div class="alumno-name">Alumno</div>
                <p class="list">7</p>
                <p ><img class="icono-alumno student-list-icon" src="../img/icono_persona.png"> LOPEZ PUCA HUGO MANUEL <a href="">Perfil</a></p>
            </div>
            <div class="separador"></div>
            <div class="representante">
                <div class="representante-name">Representante</div>
        ...
        <div class="docente">
            <div class="alumno">
                <div class="alumno-name">Alumno</div>
                <p class="list">8</p>
                <p ><img class="icono-alumno student-list-icon" src="../img/icono_persona.png"> MALASQUEZ DESPOSORIO GRISSEL ADRIANA <a href="">Perfil</a></p>
            </div>
            <div class="separador"></div>
            <div class="representante">
                <div class="representante-name">Representante</div>
        ...
        <div class="docente">
            <div class="alumno">
                <div class="alumno-name">Alumno</div>
                <p class="list">9</p>
                <p ><img class="icono-alumno student-list-icon" src="../img/icono_persona.png"> PAREDES PORTUGAL FAUSTO ENRIQUE <a href="">Perfil</a></p>
            </div>
            <div class="separador"></div>
            <div class="representante">
                <div class="representante-name">Representante</div>
        ...
        <div class="docente">
            <div class="alumno">
                <div class="alumno-name">Alumno</div>
                <p class="list">10</p>
                <p ><img class="icono-alumno student-list-icon" src="../img/icono_persona.png"> SALAZAR DAGA JULIO CESAR <a href="">Perfil</a></p>
            </div>
            <div class="separador"></div>
            <div class="representante">
                <div class="representante-name">Representante</div>
        ...
        <div class="docente">
            <div class="alumno">
                <div class="alumno-name">Alumno</div>
                <p class="list">11</p>
                <p ><img class="icono-alumno student-list-icon" src="../img/icono_persona.png"> SALVATIERRA AYALA VIANCA ROXANA <a href="">Perfil</a></p>
            </div>
            <div class="separador"></div>
            <div class="representante">
                <div class="representante-name">Representante</div>
        ...
        <div class="docente">
            <div class="alumno">
                <div class="alumno-name">Alumno</div>
                <p class="list">12</p>
                <p ><img class="icono-alumno student-list-icon" src="../img/icono_persona.png"> SILVA MARQUEZ JAIRO ANTHONY <a href="">Perfil</a></p>
            </div>
            <div class="separador"></div>
            <div class="representante">
                <div class="representante-name">Representante</div>
        ...
        <div class="docente">
            <div class="alumno">
                <div class="alumno-name">Alumno</div>
                <p class="list">13</p>
                <p ><img class="icono-alumno student-list-icon" src="../img/icono_persona.png"> SOLANO VILMA VICTOR JESUS <a href="">Perfil</a></p>
            </div>
            <div class="separador"></div>
            <div class="representante">
                <div class="representante-name">Representante</div>
        ...
        <div class="docente">
            <div class="alumno">
                <div class="alumno-name">Alumno</div>
                <p class="list">14</p>
                <p ><img class="icono-alumno student-list-icon" src="../img/icono_persona.png"> TAIPE HUAMANI GONZALO ALBERTO <a href="">Perfil</a></p>
            </div>
            <div class="separador"></div>
            <div class="representante">
                <div class="representante-name">Representante</div>
        ...
        <div class="docente">
            <div class="alumno">
                <div class="alumno-name">Alumno</div>
                <p class="list">15</p>
                <p ><img class="icono-alumno student-list-icon" src="../img/icono_persona.png"> VILLANUEVA ASENCIO ROBINSON LUIS <a href="">Perfil</a></p>
            </div>
            <div class="separador"></div>
            <div class="representante">
                <div class="representante-name">Representante</div>
...
<script type="text/javascript">
     ...
     var xhttp = new XMLHttpRequest();
      ...
      xhttp.open("GET", "xml/course8B.xml", true);
      xhttp.send();
