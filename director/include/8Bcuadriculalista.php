            <div id="alumnos-cuad" class="alumnos-master"> 
                <!--<div class="alumnos-cuadricula">
                    <div class="alumno">
                        ...
                        <h4>APAZA BASILIO LEONARDO MIGUEL</h4>
                        <a href="">
                ...
                <div class="alumnos-cuadricula">
                    <div class="alumno">
                        <img src="../img/icono_persona.png" alt="" width="25">
                        <h4>BALDERA OBREGON RONALDO TYSON</h4>
                        <a href="">
                            <button>Perfil</button>
                        </a>
                    </div>
                ...
                <div class="alumnos-cuadricula">
                    <div class="alumno">
                        <img src="../img/icono_persona.png" alt="" width="25">
                        <h4>CALDERON GUEVARA JOEL ALEXANDER</h4>
                        <a href="">
                            <button>Perfil</button>
                        </a>
                    </div>
                ...
                <div class="alumnos-cuadricula">
                    <div class="alumno">
                        <img src="../img/icono_persona.png" alt="" width="25">
                        <h4>ESTELA SAMANEZ ISAAC MANUEL</h4>
                        <a href="">
                            <button>Perfil</button>
                        </a>
                    </div>
                ...
                <div class="alumnos-cuadricula">
                    <div class="alumno">
                        <img src="../img/icono_persona.png" alt="" width="25">
                        <h4>FLORES MESA MILAGROS JANETH</h4>
                        <a href="">
                            <button>Perfil</button>
                        </a>
                    </div>
                ...
                <div class="alumnos-cuadricula">
                    <div class="alumno">
                        <img src="../img/icono_persona.png" alt="" width="25">
                        <h4>MALASQUEZ DESPOSORIO GRISSEL ADRIANA</h4>
                        <a href="">
                            <button>Perfil</button>
                        </a>
                    </div>
                ...
                <div class="alumnos-cuadricula">
                    <div class="alumno">
                        <img src="../img/icono_persona.png" alt="" width="25">
                        <h4>PAREDES PORTUGAL FAUSTO ENRIQUE</h4>
                        <a href="">
                            <button>Perfil</button>
                        </a>
                    </div>
                ...
                <div class="alumnos-cuadricula">
                    <div class="alumno">
                        <img src="../img/icono_persona.png" alt="" width="25">
                        <h4>SALAZAR DAGA JULIO CESAR</h4>
                        <a href="">
                            <button>Perfil</button>
                        </a>
                    </div>
                ...
                <div class="alumnos-cuadricula">
                    <div class="alumno">
                        <img src="../img/icono_persona.png" alt="" width="25">
                        <h4>SALVATIERRA AYALA VIANCA ROXANA</h4>
                        <a href="">
                            <button>Perfil</button>
                        </a>
                    </div>
                ...
                <div class="alumnos-cuadricula">
                    <div class="alumno">
                        <img src="../img/icono_persona.png" alt="" width="25">
                        <h4>SILVA MARQUEZ JAIRO ANTHONY</h4>
                        <a href="">
                            <button>Perfil</button>
                        </a>
                    </div>
                ...
                <div class="alumnos-cuadricula">
                    <div class="alumno">
                        <img src="../img/icono_persona.png" alt="" width="25">
                        <h4>SOLANO VILMA VICTOR JESUS</h4>
                        <a href="">
                            <button>Perfil</button>
                        </a>
                    </div>
                ...
                <div class="alumnos-cuadricula">
                    <div class="alumno">
                        <img src="../img/icono_persona.png" alt="" width="25">
                        <h4>TAIPE HUAMANI GONZALO ALBERTO</h4>
                        <a href="">
                            <button>Perfil</button>
                        </a>
                    </div>
                ...
                <div class="alumnos-cuadricula">
                    <div class="alumno">
                        <img src="../img/icono_persona.png" alt="" width="25">
                        <h4>VILLANUEVA ASENCIO ROBINSON LUIS</h4>
                        <a href="">
                            <button>Perfil</button>
                        </a>
                    </div>
