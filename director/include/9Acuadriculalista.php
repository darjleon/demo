...
<<<<<<< HEAD
                <!--<div class="alumnos-cuadricula">
                    <div class="alumno">
                        ...
                        <h4>AGUILERA QUISPE JUAN MANUEL</h4>
                        <a href="">
                ...
                <div class="alumnos-cuadricula">
                    <div class="alumno">
                        <img src="../img/icono_persona.png" alt="" width="25">
                        <h4>ALEGRE CASTRO ANDREA PAOLA</h4>
                        <a href="">
                            <button>Perfil</button>
                        </a>
                    </div>
                ...
                <div class="alumnos-cuadricula">
                    <div class="alumno">
                        <img src="../img/icono_persona.png" alt="" width="25">
                        <h4>CASTILLO MISARI FABIOLA PAMELA</h4>
                        <a href="">
                            <button>Perfil</button>
                        </a>
                    </div>
                ...
                <div class="alumnos-cuadricula">
                    <div class="alumno">
                        <img src="../img/icono_persona.png" alt="" width="25">
                        <h4>DAVILA CHAVEZ ANYEL ALEXANDRA</h4>
                        <a href="">
                            <button>Perfil</button>
                        </a>
                    </div>
                ...
                <div class="alumnos-cuadricula">
                    <div class="alumno">
                        <img src="../img/icono_persona.png" alt="" width="25">
                        <h4>FILIOS HERNANDEZ REYNALDO JERSON</h4>
                        <a href="">
                            <button>Perfil</button>
                        </a>
                    </div>
                ...
                <div class="alumnos-cuadricula">
                    <div class="alumno">
                        <img src="../img/icono_persona.png" alt="" width="25">
                        <h4>LOPEZ GOYZUETA KEVIN ADRIAN</h4>
                        <a href="">
                            <button>Perfil</button>
                        </a>
                    </div>
                ...
                <div class="alumnos-cuadricula">
                    <div class="alumno">
                        <img src="../img/icono_persona.png" alt="" width="25">
                        <h4>PADILLA CHAUCA MELANY ROCA</h4>
                        <a href="">
                            <button>Perfil</button>
                        </a>
                    </div>
                ...
                <div class="alumnos-cuadricula">
                    <div class="alumno">
                        <img src="../img/icono_persona.png" alt="" width="25">
                        <h4>PAIVA PISCOYA EDER ANDRES</h4>
                        <a href="">
                            <button>Perfil</button>
                        </a>
                    </div>
                ...
                <div class="alumnos-cuadricula">
                    <div class="alumno">
                        <img src="../img/icono_persona.png" alt="" width="25">
                        <h4>PAREDES POCCO LUIS ENRIQUE</h4>
                        <a href="">
                            <button>Perfil</button>
                        </a>
                    </div>
                ...
                <div class="alumnos-cuadricula">
                    <div class="alumno">
                        <img src="../img/icono_persona.png" alt="" width="25">
                        <h4>PINEDA ROJAS CRISTHIAN ANDRES</h4>
                        <a href="">
                            <button>Perfil</button>
                        </a>
                    </div>
                ...
                <div class="alumnos-cuadricula">
                    <div class="alumno">
                        <img src="../img/icono_persona.png" alt="" width="25">
                        <h4>QUEREVALO DAVILA SELENA STEFANIA</h4>
                        <a href="">
                            <button>Perfil</button>
                        </a>
                    </div>
                ...
                <div class="alumnos-cuadricula">
                    <div class="alumno">
                        <img src="../img/icono_persona.png" alt="" width="25">
                        <h4>QUISPE RODRIGUEZ ANGELA BRIGGITTE</h4>
                        <a href="">
                            <button>Perfil</button>
                        </a>
                    </div>
                ...
                <div class="alumnos-cuadricula">
                    <div class="alumno">
                        <img src="../img/icono_persona.png" alt="" width="25">
                        <h4>REGALADO ALFARO SAUL ALEXIS</h4>
                        <a href="">
                            <button>Perfil</button>
                        </a>
                    </div>
                ...
                <div class="alumnos-cuadricula">
                    <div class="alumno">
                        <img src="../img/icono_persona.png" alt="" width="25">
                        <h4>ROMERO SALVATIERRA TANIA MARCELA</h4>
                        <a href="">
                            <button>Perfil</button>
                        </a>
                    </div>
                ...
                <div class="alumnos-cuadricula">
                    <div class="alumno">
                        <img src="../img/icono_persona.png" alt="" width="25">
                        <h4>SAENZ TEJADA LORENA ROXANA</h4>
                        <a href="">
                            <button>Perfil</button>
                        </a>
                    </div>
...
<script type="text/javascript">
     ...
     var xhttp = new XMLHttpRequest();
      ...
      xhttp.open("GET", "xml/course9A.xml", true);
      xhttp.send();
