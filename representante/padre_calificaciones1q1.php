...
<div id="wrapper">
    ...
    <div id="page-wrapper" class="gray-bg dashbard-1">
        ...
        <div class="wrapper wrapper-content animated fadeInRight">
            <div class="row">
                <div class="col-lg-12 padre-calificaciones">
                    <h2 class="text-left" style="margin-top:0">
                        <img src="../img/calificaciones.png" style="width:50px">  Calificaciones<span>|</span> Periodo : <label>2016-2017</label> <span>|</span> Quimestre 1
                    </h2>
                </div>                                            
            </div>
