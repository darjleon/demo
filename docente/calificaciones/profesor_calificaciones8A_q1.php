                ...
                <div class="col-lg-12">
                    <div class="tabs-container" style="padding-top:10px">
                        <ul class="nav nav-tabs text-center">                            
                            <li class="active"><a data-toggle="tab" href="#tab-p1">Primer Parcial</a></li>
                            <li><a data-toggle="tab" href="#tab-p2">Segundo Parcial</a></li>
                            <li><a data-toggle="tab" href="#tab-p3">Tercer Parcial</a></li>
                            <li><a data-toggle="tab" href="#tab-ex">Examen</a></li>
                            <li><a data-toggle="tab" href="#tab-q">Quimestral</a></li>
                        </ul>
