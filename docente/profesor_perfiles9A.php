...
<div id="wrapper">
    ...
    <div id="page-wrapper" class="gray-bg dashbard-1">
        ...
        <div class="row wrapper white-bg" style="padding-top:5px">
            ...
            <div class="col-lg-5">                
                <h4 style="margin-left:0;margin-bottom: 0"><strong>CURSO: </strong>9 'A'</h4>
                <h4><strong>DIRIGENTE: </strong>MERY URBINA ANDALUZ</h4>        
            ...
            <div class="col-lg-6 text-right" style="margin-top:5px;margin-right: -15px">
                <ul>
                    <li style="display:inline-block">
                        <a href="profesor_asistencia9A.php">
                    ...
                    <li style="display:inline-block">
                        <a href="profesor_calificaciones9A.php">
