    ...
    <!--<div class="col-xs-12"> 
        ...
        <div class="docente">
            <div class="alumno">
                ...
                <p class="list">1</p>
                <p><img class="icono-alumno student-list-icon" src="../img/icono_persona.png"> ACOSTA GARCIA JESUS DANIEL
                <a href="">Perfil</a></p>
            </div>
        ...
        <div class="docente">
            <div class="alumno">
                <div class="alumno-name">Alumno</div>
                <p class="list">2</p>
                <p><img class="icono-alumno student-list-icon" src="../img/icono_persona.png"> AYALA LOZANO VICTORIA EUGENIA
                <a href="">Perfil</a></p>
            </div>
            <div class="separador"></div>
            <div class="representante">
        ...
        <div class="docente">
            <div class="alumno">
                <div class="alumno-name">Alumno</div>
                <p class="list">3</p>
                <p><img class="icono-alumno student-list-icon" src="../img/icono_persona.png"> CASTAÑO VELEZ ANA CAROLINA
                <a href="">Perfil</a></p>
            </div>
            <div class="separador"></div>
            <div class="representante">
        ...
        <div class="docente">
            <div class="alumno">
                <div class="alumno-name">Alumno</div>
                <p class="list">4</p>
                <p><img class="icono-alumno student-list-icon" src="../img/icono_persona.png"> CASTILLO GIRALDO JOHANA CAROLINA
                <a href="">Perfil</a></p>
            </div>
            <div class="separador"></div>
            <div class="representante">
        ...
        <div class="docente">
            <div class="alumno">
                <div class="alumno-name">Alumno</div>
                <p class="list">5</p>
                <p><img class="icono-alumno student-list-icon" src="../img/icono_persona.png"> ESCOBAR PRADO LILIVE ANDREA
                <a href="">Perfil</a></p>
            </div>
            <div class="separador"></div>
            <div class="representante">
        ...
        <div class="docente">
            <div class="alumno">
                <div class="alumno-name">Alumno</div>
                <p class="list">6</p>
                <p><img class="icono-alumno student-list-icon" src="../img/icono_persona.png"> GOMEZ ARIAS MARIA CAMILA
                <a href="">Perfil</a></p>
            </div>
            <div class="separador"></div>
            <div class="representante">
        ...
        <div class="docente">
            <div class="alumno">
                <div class="alumno-name">Alumno</div>
                <p class="list">7</p>
                <p><img class="icono-alumno student-list-icon" src="../img/icono_persona.png"> GOMEZ RAMIREZ KEVIN DARIO
                <a href="">Perfil</a></p>
            </div>
            <div class="separador"></div>
            <div class="representante">
        ...
        <div class="docente">
            <div class="alumno">
                <div class="alumno-name">Alumno</div>
                <p class="list">8</p>
                <p><img class="icono-alumno student-list-icon" src="../img/icono_persona.png"> HERNANDEZ PRECIADO JHON ALEXANDER
                <a href="">Perfil</a></p>
            </div>
            <div class="separador"></div>
            <div class="representante">
        ...
        <div class="docente">
            <div class="alumno">
                <div class="alumno-name">Alumno</div>
                <p class="list">9</p>
                <p><img class="icono-alumno student-list-icon" src="../img/icono_persona.png"> LOPEZ CASTAÑO MARIA ADELAIDA
                <a href="">Perfil</a></p>
            </div>
            <div class="separador"></div>
            <div class="representante">
        ...
        <div class="docente">
            <div class="alumno">
                <div class="alumno-name">Alumno</div>
                <p class="list">10</p>
                <p><img class="icono-alumno student-list-icon" src="../img/icono_persona.png"> PALACIOS QUINTERO JUAN CARLOS
                <a href="">Perfil</a></p>
            </div>
            <div class="separador"></div>
            <div class="representante">
        ...
        <div class="docente">
            <div class="alumno">
                <div class="alumno-name">Alumno</div>
                <p class="list">11</p>
                <p><img class="icono-alumno student-list-icon" src="../img/icono_persona.png"> QUINTERO GOMEZ MARIA PAOLA
                <a href="">Perfil</a></p>
            </div>
            <div class="separador"></div>
            <div class="representante">
        ...
        <div class="docente">
            <div class="alumno">
                <div class="alumno-name">Alumno</div>
                <p class="list">12</p>
                <p><img class="icono-alumno student-list-icon" src="../img/icono_persona.png"> TORRES CORREA JUAN DAVID
                <a href="">Perfil</a></p>
            </div>
            <div class="separador"></div>
            <div class="representante">
        ...
        <div class="docente">
            <div class="alumno">
                <div class="alumno-name">Alumno</div>
                <p class="list">13</p>
                <p><img class="icono-alumno student-list-icon" src="../img/icono_persona.png"> VALENCIA VEGA ADRIANA PATRICIA
                <a href="">Perfil</a></p>
            </div>
            <div class="separador"></div>
            <div class="representante">
        ...
        <div class="docente">
            <div class="alumno">
                <div class="alumno-name">Alumno</div>
                <p class="list">14</p>
                <p><img class="icono-alumno student-list-icon" src="../img/icono_persona.png"> VELASQUEZ OLARTE JORGE EDUARDO
                <a href="">Perfil</a></p>
            </div>
            <div class="separador"></div>
            <div class="representante">
        ...
        <div class="docente">
            <div class="alumno">
                <div class="alumno-name">Alumno</div>
                <p class="list">15</p>
                <p><img class="icono-alumno student-list-icon" src="../img/icono_persona.png"> ZAPATA MERINO MARIA JOSE
                <a href="">Perfil</a></p>
            </div>
            <div class="separador"></div>
            <div class="representante">
...
<script type="text/javascript">
     ...
     var xhttp = new XMLHttpRequest();
      ...
      xhttp.open("GET", "xml/course10B.xml", true);
      xhttp.send();
