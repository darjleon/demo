            <div id="alumnos-cuad" class="alumnos-master"> 
                <!--<div class="alumnos-cuadricula">
                    <div class="alumno">
                        ...
                        <h4>ALVARADO AVILES KARLA DOMENIQUE</h4>
                        <a href="">
                ...
                <div class="alumnos-cuadricula">
                    <div class="alumno">
                        <img src="../img/icono_persona.png" alt="" width="25">
                        <h4>AMAGUAYA VILLAVICENCIO EDNWING FABRICIO</h4>
                        <a href="">
                            <button>Perfil</button>
                        </a>
                    </div>
                ...
                <div class="alumnos-cuadricula">
                    <div class="alumno">
                        <img src="../img/icono_persona.png" alt="" width="25">
                        <h4>BAQUE CANO ANDRES MARCELINO</h4>
                        <a href="">
                            <button>Perfil</button>
                        </a>
                    </div>
                ...
                <div class="alumnos-cuadricula">
                    <div class="alumno">
                        <img src="../img/icono_persona.png" alt="" width="25">
                        <h4>BUÑAY CANTOS VICTOR JOSUE</h4>
                        <a href="">
                            <button>Perfil</button>
                        </a>
                    </div>
                ...
                <div class="alumnos-cuadricula">
                    <div class="alumno">
                        <img src="../img/icono_persona.png" alt="" width="25">
                        <h4>CONGUIA ESCOBAR LILIBETH</h4>
                        <a href="">
                            <button>Perfil</button>
                        </a>
                    </div>
                ...
                <div class="alumnos-cuadricula">
                    <div class="alumno">
                        <img src="../img/icono_persona.png" alt="" width="25">
                        <h4>CORREA PAZ BRITTANY PAULINA</h4>
                        <a href="">
                            <button>Perfil</button>
                        </a>
                    </div>
                ...
                <div class="alumnos-cuadricula">
                    <div class="alumno">
                        <img src="../img/icono_persona.png" alt="" width="25">
                        <h4>FIGUEROA ROBAYO MARJORIE MICHELE</h4>
                        <a href="">
                            <button>Perfil</button>
                        </a>
                    </div>
                ...
                <div class="alumnos-cuadricula">
                    <div class="alumno">
                        <img src="../img/icono_persona.png" alt="" width="25">
                        <h4>GARCIA CELI JAIME EDUARDO </h4>
                        <a href="">
                            <button>Perfil</button>
                        </a>
                    </div>
                ...
                <div class="alumnos-cuadricula">
                    <div class="alumno">
                        <img src="../img/icono_persona.png" alt="" width="25">
                        <h4>HOLGUIN CISNEROS DANNA NOHELY</h4>
                        <a href="">
                            <button>Perfil</button>
                        </a>
                    </div>
                ...
                <div class="alumnos-cuadricula">
                    <div class="alumno">
                        <img src="../img/icono_persona.png" alt="" width="25">
                        <h4>LOPEZ CANO DOLORES MARGARITA</h4>
                        <a href="">
                            <button>Perfil</button>
                        </a>
                    </div>
                ...
                <div class="alumnos-cuadricula">
                    <div class="alumno">
                        <img src="../img/icono_persona.png" alt="" width="25">
                        <h4>MARTINEZ PINO MICHAEL STEVEN</h4>
                        <a href="">
                            <button>Perfil</button>
                        </a>
                    </div>
                ...
                <div class="alumnos-cuadricula">
                    <div class="alumno">
                        <img src="../img/icono_persona.png" alt="" width="25">
                        <h4>MENDOZA COTO CRISTOPHER JOSUE</h4>
                        <a href="">
                            <button>Perfil</button>
                        </a>
                    </div>
                ...
                <div class="alumnos-cuadricula">
                    <div class="alumno">
                        <img src="../img/icono_persona.png" alt="" width="25">
                        <h4>MOREIRA TORRES PAMELA LISETTE</h4>
                        <a href="">
                            <button>Perfil</button>
                        </a>
                    </div>
                ...
                <div class="alumnos-cuadricula">
                    <div class="alumno">
                        <img src="../img/icono_persona.png" alt="" width="25">
                        <h4>MOROCHO PEÑAFIEL JOSE BENJAMIN</h4>
                        <a href="">
                            <button>Perfil</button>
                        </a>
                    </div>
                ...
                <div class="alumnos-cuadricula">
                    <div class="alumno">
                        <img src="../img/icono_persona.png" alt="" width="25">
                        <h4>MUÑOZ SANCHEZ JOSE RICARDO</h4>
                        <a href="">
                            <button>Perfil</button>
                        </a>
                    </div>
                ...
                <div class="alumnos-cuadricula">
                    <div class="alumno">
                        <img src="../img/icono_persona.png" alt="" width="25">
                        <h4>QUIÑONES QUINTERO RENSO GERMAN</h4>
                        <a href="">
                            <button>Perfil</button>
                        </a>
                    </div>
                ...
                <div class="alumnos-cuadricula">
                    <div class="alumno">
                        <img src="../img/icono_persona.png" alt="" width="25">
                        <h4>SABANDO LINDAO JOSUE SAUL</h4>
                        <a href="">
                            <button>Perfil</button>
                        </a>
                    </div>
                ...
                <div class="alumnos-cuadricula">
                    <div class="alumno">
                        <img src="../img/icono_persona.png" alt="" width="25">
                        <h4>VASQUEZ BARAHONA CESAR FERNANDO</h4>
                        <a href="">
                            <button>Perfil</button>
                        </a>
                    </div>
                ...
                <div class="alumnos-cuadricula">
                    <div class="alumno">
                        <img src="../img/icono_persona.png" alt="" width="25">
                        <h4>YERBABUENA RAMON LUIS ANTONIO</h4>
                        <a href="">
                            <button>Perfil</button>
                        </a>
                    </div>
...
<script type="text/javascript">
     ...
     var xhttp = new XMLHttpRequest();
      ...
      xhttp.open("GET", "xml/course3INFORMATICA.xml", true);
      xhttp.send();
