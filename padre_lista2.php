...
<div id="wrapper">
    ...
    <div id="page-wrapper" class="gray-bg dashbard-1">
        ...
        <div class="wrapper wrapper-content">
            ...
            <div class="row">
                <div class="col-lg-12" style="background-color: #939598;color: white;margin-top:10px;margin-bottom:20px">
                    <h2 style="font-weight: bold">Lista de alumnos</h2>
                </div>
            </div>  
            <div class="row">
                <div class="col-lg-3">
                    <div class="contact-box">
                        <div class="col-sm-3">
                            <div class="text-center">
                                <img src="img/icono persona.png" width="40px">
                            </div>
                        </div>
                        <div class="col-sm-9">
                            <h5>EDUARDO ANDRES AVILES MONTUFAR</h5>
                        </div>
                ...
                <div class="col-lg-3">
                    <div class="contact-box">
                        ...
                        <div class="col-sm-9">
                            <h5>ANDRES ALEXANDER BALLADARES FUENTES</h5>
                        </div>
                        <div class="clearfix"></div>
                    </div>
                </div>
                <div class="col-lg-3">
                    <div class="contact-box">
                        ...
                        <div class="col-sm-9">
                            <h5>BETSABETH SOLEDAD BASURTO SORIANA</h5>
                        </div>
                        <div class="clearfix"></div>
                    </div>
                </div>
                <div class="col-lg-3">
                    <div class="contact-box">
                        ...
                        <div class="col-sm-9">
                            <h5>DAVID EDUARDO CHOEZ RONQUILLO</h5>
                        </div>
                        <div class="clearfix"></div>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-lg-3">
                    <div class="contact-box">
                        ...
                        <div class="col-sm-9">
                            <h5>ARIEL ANIBAL ENGRACIA PAREDES</h5>
                        </div>
                        <div class="clearfix"></div>
                    </div>
                </div> 
                <div class="col-lg-3">
                    <div class="contact-box">                        
                        ...
                        <div class="col-sm-9">
                            <h5>MOISES EDISON FRANCO SARATE</h5>
                        </div>
                        <div class="clearfix"></div>
                    </div>
                </div> 
                <div class="col-lg-3">
                    <div class="contact-box">                        
                        ...
                        <div class="col-sm-9">
                            <h5>DAVID GENARO FUENTES MONTENEGRO</h5>
                        </div>
                        <div class="clearfix"></div>
                    </div>
                </div> 
                <div class="col-lg-3">
                    <div class="contact-box " style="margin-top:5px;margin-bottom:5px">                        
                        <div class="col-sm-3">
                            <div class="text-center">
                                <img src="img/icono persona.png" width="40px">
                            </div>
                        ...
                        <div class="col-sm-9">
                            <h5>GABRIEL WLADIMIR GALECIO ARAUJO</h5>
                        </div>
                        <div class="clearfix"></div>
                    </div>
                </div> 
            ...
            <div class="row">
                <div class="col-lg-3">
                    <div class="contact-box ">                        
                        ...
                        <div class="col-sm-9">
                            <h5>DEREK ALEJANDRO HERRERA SANTAMARIA</h5>
                        </div>
                        <div class="clearfix"></div>
                    </div>
                </div> 
                <div class="col-lg-3">
                    <div class="contact-box ">                        
                        ...
                        <div class="col-sm-9">
                            <h5>OMAR STEVEN LIMA SANCHEZ</h5>
                        </div>
                        <div class="clearfix"></div>
                    </div>
                </div> 
                <div class="col-lg-3">
                    <div class="contact-box ">                        
                        ...
                        <div class="col-sm-9">
                            <h5>GREGORY PAUL MIRANDA ACUÑIA</h5>
                        </div>
                        <div class="clearfix"></div>
                    </div>
                </div> 
            ...
            <div class="row">
                <div class="col-lg-3">
                    <div class="contact-box ">                        
                        ...
                        <div class="col-sm-9">
                            <h5>ANDRES FERNANDO MURILLO VALLEJOS</h5>
                        </div>
                        <div class="clearfix"></div>
                    </div>
                </div>
                <div class="col-lg-3">
                    <div class="contact-box ">                        
                        ...
                        <div class="col-sm-9">
                            <h5>JOSHUE FERNANDO PEREZ BRIONES</h5>
                        </div>
                        <div class="clearfix"></div>
                    </div>
                </div> 
            ...
            <div class="row">
                ...
                <div class="col-lg-3">
                    <div class="contact-box ">                        
                        ...
                        <div class="col-sm-9">
                            <h5>KEVIN FABIAN TIPAN CAIMINAGUA</h5>
                        </div>
                        <div class="clearfix"></div>
                    </div>
                </div> 
                <div class="col-lg-3">
                    <div class="contact-box ">                        
                        ...
                        <div class="col-sm-9">
                            <h5>STEVEN JAVIER TOALA CEDEÑO</h5>
                        </div>
                        <div class="clearfix"></div>
                    </div>
                </div> 
                <div class="col-lg-3">
                    <div class="contact-box ">                        
                        ...
                        <div class="col-sm-9">
                            <h5>IVAN ALFONSO >VERA  VALLEJO</h5>
                        </div>
                        <div class="clearfix"></div>
                    </div>
                </div>  
            ...
            <div class="row">
                <div class="col-lg-3">
                    <div class="contact-box ">                        
                        ...
                        <div class="col-sm-9">
                            <h5>KARELYS NOELIA VINCES LEON</h5>
                        </div>
                        <div class="clearfix"></div>
                    </div>
                </div> 
